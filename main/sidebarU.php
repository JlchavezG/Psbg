<div class="d-flex" id="wrapper">
  ...
  <div class="bg-dark text-light" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
      ...
      <a href="#" class="list-group-item list-group-item-action bg-dark text-light"><span class="icon-comment"></span> Notificaciones</a>
      <a href="#" class="list-group-item list-group-item-action bg-dark text-light"><span class="icon-book"></span> Acerca de</a>
    </div>
  </div>
  <!-- termina el Sidebar -->
