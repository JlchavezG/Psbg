...
function actions(boton){
  if(boton.className=="buttons"){
    ...
    boton.value=text;
    boton.appenChild(document.createTextNode(text));
    con++;
    asignation(text,boton);
  } else{
    // mandar una alerta de clikea por favor o eres el siguinte
  }
}
...
function validation(text){
  if((b1 == b2 && b3 == b3) || (b1 == b5 && b5 == b9) || (b3 == b5 && b5 == b7) || (b4 == b5 && b5 == b6) || (b7 == b8 && b8 == b9) ||
     (b1 == b4 && b4 == b7) || (b3 == b5 && b5 == b8) || (b3 == b6 && b6 == b9)){
       var con=confirm(text+ "Has ganado !! ¿Quieres jugar otra vez?");
       if(con == true){
